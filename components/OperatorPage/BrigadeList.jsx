...
const BrigadeList = () => {
  const [brigades, setBrigades] = useState([
    { id: 2, name: 'Бригада 3', requestDayCount: 5, requestMonthCount: 33, call: "0708780274" },
    { id: 1, name: 'Бригада 1', requestDayCount: 5, requestMonthCount: 21, call: "0708780274" },
  ])
  const columns = [
    {
      title: "№",
  ...
  return (
    <div>
      <Table dataSource={brigades} columns={columns} rowKey="id" />;
    </div>
  );
};
